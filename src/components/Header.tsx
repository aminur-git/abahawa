    ...
    return (
        <header className=" px-2  py-4 sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
            <div className='flex justify-between container mx-auto items-center'>
                <Link to={"/"} className='flex justify-between items-center text-xl md:text-4xl gap-2 font-black '>
                    {/* <Cloudy className={theme === 'dark' ? 'text-cyan-300' : 'text-cyan-800'} />  */}
                    <img className='h-16 w-16 ' src={theme === 'dark' ? "/icon.png" : "/iconDark.png"} alt="" />
